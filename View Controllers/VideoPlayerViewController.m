...
@interface VideoPlayerViewController ()<NSSplitViewDelegate,NSDraggingDestination,SBViewDragFileDelegate,NSTableViewDelegate,NSTableViewDataSource,SBPlaylistItemDelegate,NSUserNotificationCenterDelegate,ColorPanelViewControllerDelegate>
