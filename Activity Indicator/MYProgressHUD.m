...
{
    MYProgressHUD* theHUD = [self instance];
...
- (void)addMask {
    ...
    backgroundMask.transparent = YES;
...
- (void)initializePopup
{
    ...
    activityIndicator = [[MyActivityIndicator alloc] init];
    progressIndicator = [[MYProgressIndicator alloc] init];
