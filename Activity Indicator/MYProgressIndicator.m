...
- (ProgressActivityBezierPath *)createCirclePathWithCenter:(CGPoint)center radius:(CGFloat)radius sampleCount:(NSInteger)sampleCount {
    
    ProgressActivityBezierPath *smoothedPath = [[ProgressActivityBezierPath alloc] init];
...
- (CAShapeLayer *)createRingLayerWithCenter:(CGPoint)center radius:(CGFloat)radius lineWidth:(CGFloat)lineWidth color:(NSColor *)color {
    ...
    ProgressActivityBezierPath *smoothedPath = [self createCirclePathWithCenter:center radius:radius sampleCount:72];
