...
class ViewController: NSViewController {
    ...
    @IBAction func clickedButton(_ sender: Any) {
        ...
        SBApplication.share().filePaths = [self.fileOutput]
        (delegate.videoPlayerWindowController.contentViewController as! VideoPlayerViewController).sbViewGetFileURL(self.fileOutput)
        (delegate.videoPlayerWindowController.contentViewController as! VideoPlayerViewController).playlistDataAddToDatabase()
